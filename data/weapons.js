...
const HAND_VERIFIED_WEAPONS = [
  ...
  { id: 'thrilling_tales_of_dragon_slayers', name: 'Thrilling Tales of Dragon Slayers', type: 'Catalyst', rarity: 3, baseAtk: 401, subStat: 'hpPercent', subStatValue: 41.3 },
  ...
  { id: 'a_thousand_floating_dreams', name: 'A Thousand Floating Dreams', type: 'Catalyst', rarity: 5, baseAtk: 542, subStat: 'em', subStatValue: 132.4 },
...
const GENERATED_WEAPONS = [
  ...
  tierWeapon('crimson_moons_semblance', "Crimson Moon's Semblance", 'Polearm', 5, 'critRate'),
  ...
  tierWeapon('wolf_fang', 'Wolf-Fang', 'Sword', 4, 'critRate'),
  ...
  tierWeapon('verdict', 'Verdict', 'Claymore', 5, 'critRate'),

  // Polearms
  tierWeapon('angelos_heptades', "Angelos' Heptades", 'Polearm', 5, 'atkFlat'),
  tierWeapon('fang_of_the_mountain_king', 'Fang of the Mountain King', 'Claymore', 5, 'critRate'),
  tierWeapon('halberd', 'Halberd', 'Polearm', 4, 'atkPercent'),
  tierWeapon('chain_breaker', 'Chain Breaker', 'Polearm', 4, 'atkPercent'),
  tierWeapon('cinnabar_spindle', 'Cinnabar Spindle', 'Sword', 4, 'defPercent'),
  ...
  tierWeapon('earth_shaker', 'Earth Shaker', 'Claymore', 4, 'atkPercent'),
  ...
  tierWeapon('footprint_of_the_rainbow', 'Footprint of the Rainbow', 'Polearm', 4, 'atkPercent'),
  tierWeapon('rightful_reward', 'Rightful Reward', 'Polearm', 4, 'hpPercent'),
  tierWeapon('dialogues_of_the_desert_sages', 'Dialogues of the Desert Sages', 'Polearm', 4, 'hpPercent'),
  ...
  tierWeapon('ballad_of_the_fjords', 'Ballad of the Fjords', 'Polearm', 4, 'critRate'),
  ...
  tierWeapon('wavebreakers_fin', "Wavebreaker's Fin", 'Polearm', 5, 'atkFlat'),
  ...
  // Catalysts
  tierWeapon('lightbearing_moonshard', 'Lightbearing Moonshard', 'Sword', 5, 'critDmg'),
  ...
  tierWeapon('splendor_of_tranquil_waters', 'Splendor of Tranquil Waters', 'Sword', 5, 'critDmg'),
  ...
  tierWeapon('flame_forged_insight', 'Flame-Forged Insight', 'Claymore', 4, 'em'),
  tierWeapon('forest_regalia', 'Forest Regalia', 'Claymore', 4, 'er'),
  ...
  tierWeapon('mailed_flower', 'Mailed Flower', 'Claymore', 4, 'em'),
  tierWeapon('makhaira_aquamarine', 'Makhaira Aquamarine', 'Claymore', 4, 'em'),
  ...
  tierWeapon('tidal_shadow', 'Tidal Shadow', 'Claymore', 4, 'atkPercent'),
  tierWeapon('the_catch', 'The Catch', 'Polearm', 4, 'er'),
  tierWeapon('ultimate_overlords_mega_magic_sword', "Ultimate Overlord's Mega Magic Sword", 'Claymore', 4, 'er'),
  ...
  tierWeapon('jadefalls_splendor', "Jadefall's Splendor", 'Catalyst', 5, 'critDmg'),
];
